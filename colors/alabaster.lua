...
if vim.o.background == "dark" then
	...
	theme = {
		...
		DiagnosticUnderlineWarn = { bg = "none", fg = "#C8935D", undercurl = 1 },
		DiagnosticUnderlineError = { bg = "none", fg = "#D1503A", undercurl = 1 },
		...
		--- sql
		["@keyword.sql"] = { link = "@AlabasterConstant" },
		["@variable.member.sql"] = { link = "@AlabasterDefinition" },
		["@number.sql"] = { link = "@variable" },
		["@number.float.sql"] = { link = "@variable" },
		--- yml
...
------------------------------------------------------------------------------
	...
	theme = {
		...
		LineNr = { fg = "#7d7c7c" },
		CursorLineNr = { fg = ansi.blue, bold = 1 },
		MatchParen = { bg = "#e3b341", fg = ansi.black },
		...
		Todo = { bg = "none", fg = "#4BA8FF" },
		["@comment.todo.comment"] = { bg = "none", fg = "#4BA8FF" },
		["@comment.note.comment"] = { bg = "none", fg = "#FF57FF" },
		["@comment.warning.comment"] = { bg = "none", fg = "#FF9900" },
		["@comment.error.comment"] = { bg = "none", fg = "#ff8b64" },
		["@text.todo"] = { bg = "none", fg = "#4BA8FF" },
		["@text.note"] = { fg = "#ff57fF", bg = "none" },
		["@text.warning"] = { fg = "#ff9900", bg = "none" },
		["@text.danger"] = { fg = "#ff8b64", bg = "none" },
		["@text.uri"] = { bg = "none", fg = "#4BA8FF", underline = true },
		-- ["@unchecked_list_item"] = { link = "normal" },
		-- ["@checked_list_item"] = { fg = "#696969", strikethrough = true },
		-- ["@text.todo.unchecked"] = { link = "@unchecked_list_item" },
		-- ["@text.todo.checked"] = { link = "@checked_list_item" },
		...
		ISwapGrey = { fg = "#bfbfbf" },
		-- Flash
		FlashLabel = { fg = "#3F240A", bg = "#C8935D" },
